...
class RandomCardsDate extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      datas: {},
  ...
  getData(props) {
    ...
    const url = `https://collectionapi.metmuseum.org/public/collection/v1/search?${params.id}&q=%22%22`;
    console.log(url);
...
export default RandomCardsDate;
